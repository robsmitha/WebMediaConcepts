...
DROP TABLE IF EXISTS `applicationtemplate`.`blogcategory`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_blogcategory_Load`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_blogcategory_LoadAll`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_blogcategory_Add`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_blogcategory_Update`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_blogcategory_Delete`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_blogcategory_Search`;
...
CREATE TABLE `applicationtemplate`.`blogcategory` (
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_blogcategory_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_blogcategory_LoadAll`
()
BEGIN
	SELECT
		`blogcategory`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_blogcategory_Add`
(
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_blogcategory_Update`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025)
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_blogcategory_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_blogcategory_Search`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025)
...
DROP TABLE IF EXISTS `applicationtemplate`.`itemtype`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_itemtype_Load`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_itemtype_LoadAll`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_itemtype_Add`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_itemtype_Update`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_itemtype_Delete`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_itemtype_Search`;
...
CREATE TABLE `applicationtemplate`.`itemtype` (
Id INT AUTO_INCREMENT,
Name VARCHAR(255),
Description VARCHAR(1025),
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_itemtype_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_itemtype_LoadAll`
()
BEGIN
	SELECT
		`itemtype`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_itemtype_Add`
(
	 IN paramName VARCHAR(255),
	 IN paramDescription VARCHAR(1025)
)
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_itemtype_Update`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025)
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_itemtype_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_itemtype_Search`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025)
...
DROP TABLE IF EXISTS `applicationtemplate`.`blogcommentstatustype`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_blogcommentstatustype_Load`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_blogcommentstatustype_LoadAll`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_blogcommentstatustype_Add`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_blogcommentstatustype_Update`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_blogcommentstatustype_Delete`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_blogcommentstatustype_Search`;
...
CREATE TABLE `applicationtemplate`.`blogcommentstatustype` (
Id INT AUTO_INCREMENT,
Name VARCHAR(255),
Description VARCHAR(1025),
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_blogcommentstatustype_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_blogcommentstatustype_LoadAll`
()
BEGIN
	SELECT
		`blogcommentstatustype`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_blogcommentstatustype_Add`
(
	 IN paramName VARCHAR(255),
	 IN paramDescription VARCHAR(1025)
)
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_blogcommentstatustype_Update`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025)
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_blogcommentstatustype_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_blogcommentstatustype_Search`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025)
...
DROP TABLE IF EXISTS `applicationtemplate`.`cartstatustype`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_cartstatustype_Load`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_cartstatustype_LoadAll`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_cartstatustype_Add`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_cartstatustype_Update`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_cartstatustype_Delete`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_cartstatustype_Search`;
...
CREATE TABLE `applicationtemplate`.`cartstatustype` (
Id INT AUTO_INCREMENT,
Name VARCHAR(255),
Description VARCHAR(1025),
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_cartstatustype_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_cartstatustype_LoadAll`
()
BEGIN
	SELECT
		`cartstatustype`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_cartstatustype_Add`
(
	 IN paramName VARCHAR(255),
	 IN paramDescription VARCHAR(1025)
)
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_cartstatustype_Update`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025)
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_cartstatustype_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_cartstatustype_Search`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025)
...
DROP TABLE IF EXISTS `applicationtemplate`.`eventtype`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_eventtype_Load`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_eventtype_LoadAll`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_eventtype_Add`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_eventtype_Update`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_eventtype_Delete`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_eventtype_Search`;
...
CREATE TABLE `applicationtemplate`.`eventtype` (
Id INT AUTO_INCREMENT,
Name VARCHAR(255),
Description VARCHAR(1025),
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_eventtype_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_eventtype_LoadAll`
()
BEGIN
	SELECT
		`eventtype`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_eventtype_Add`
(
	 IN paramName VARCHAR(255),
	 IN paramDescription VARCHAR(1025)
)
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_eventtype_Update`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025)
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_eventtype_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_eventtype_Search`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025)
...
DROP TABLE IF EXISTS `applicationtemplate`.`itemstatustype`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_itemstatustype_Load`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_itemstatustype_LoadAll`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_itemstatustype_Add`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_itemstatustype_Update`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_itemstatustype_Delete`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_itemstatustype_Search`;
...
CREATE TABLE `applicationtemplate`.`itemstatustype` (
Id INT AUTO_INCREMENT,
Name VARCHAR(255),
Description VARCHAR(1025),
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_itemstatustype_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_itemstatustype_LoadAll`
()
BEGIN
	SELECT
		`itemstatustype`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_itemstatustype_Add`
(
	 IN paramName VARCHAR(255),
	 IN paramDescription VARCHAR(1025)
)
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_itemstatustype_Update`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025)
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_itemstatustype_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_itemstatustype_Search`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025)
...
DROP TABLE IF EXISTS `applicationtemplate`.`blog`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_blog_Load`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_blog_LoadAll`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_blog_Add`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_blog_Update`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_blog_Delete`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_blog_Search`;
...
CREATE TABLE `applicationtemplate`.`blog` (
Id INT AUTO_INCREMENT,
Title VARCHAR(255),
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_blog_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_blog_LoadAll`
()
BEGIN
	SELECT
		`blog`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_blog_Add`
(
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_blog_Update`
(
	IN paramId INT,
	IN paramTitle VARCHAR(255),
	IN paramDescription VARCHAR(32768),
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_blog_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_blog_Search`
(
	IN paramId INT,
	IN paramTitle VARCHAR(255),
	IN paramDescription VARCHAR(32768),
...
DROP TABLE IF EXISTS `applicationtemplate`.`blogcomment`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_blogcomment_Load`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_blogcomment_LoadAll`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_blogcomment_Add`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_blogcomment_Update`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_blogcomment_Delete`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_blogcomment_Search`;
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_blogcomment_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_blogcomment_LoadAll`
()
BEGIN
	SELECT
		`blogcomment`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_blogcomment_Update`
(
	IN paramId INT,
	IN paramComment VARCHAR(32768),
	IN paramCustomerId INT,
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_blogcomment_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_blogcomment_Search`
(
	IN paramId INT,
	IN paramComment VARCHAR(32768),
	IN paramCustomerId INT,
...
DROP TABLE IF EXISTS `applicationtemplate`.`item`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_item_Load`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_item_LoadAll`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_item_Add`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_item_Update`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_item_Delete`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_item_Search`;
...
CREATE TABLE `applicationtemplate`.`item` (
Id INT AUTO_INCREMENT,
Name VARCHAR(255),
Description VARCHAR(1025),
ImgUrl VARCHAR(1025),
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_item_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_item_LoadAll`
()
BEGIN
	SELECT
		`item`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_item_Add`
(
	 IN paramName VARCHAR(255),
	 IN paramDescription VARCHAR(1025),
	 IN paramImgUrl VARCHAR(1025),
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_item_Update`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025),
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_item_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_item_Search`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025),
...
DROP TABLE IF EXISTS `applicationtemplate`.`cartitem`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_cartitem_Load`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_cartitem_LoadAll`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_cartitem_Add`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_cartitem_Update`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_cartitem_Delete`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_cartitem_Search`;
...
CREATE TABLE `applicationtemplate`.`cartitem` (
Id INT AUTO_INCREMENT,
CartId INT,
ItemId INT,
AddDate DATETIME,
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_cartitem_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_cartitem_LoadAll`
()
BEGIN
	SELECT
		`cartitem`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_cartitem_Add`
(
	 IN paramCartId INT,
	 IN paramItemId INT,
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_cartitem_Update`
(
	IN paramId INT,
	IN paramCartId INT,
	IN paramItemId INT,
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_cartitem_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_cartitem_Search`
(
	IN paramId INT,
	IN paramCartId INT,
	IN paramItemId INT,
...
DROP TABLE IF EXISTS `applicationtemplate`.`event`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_event_Load`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_event_LoadAll`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_event_Add`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_event_Update`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_event_Delete`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_event_Search`;
...
CREATE TABLE `applicationtemplate`.`event` (
Id INT AUTO_INCREMENT,
Name VARCHAR(255),
Description VARCHAR(1025),
ImgUrl VARCHAR(1025),
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_event_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_event_Add`
(
	 IN paramName VARCHAR(255),
	 IN paramDescription VARCHAR(1025),
	 IN paramImgUrl VARCHAR(1025),
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_event_Update`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025),
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_event_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_event_Search`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025),
...
DROP TABLE IF EXISTS `applicationtemplate`.`eventcomment`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_eventcomment_Load`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_eventcomment_LoadAll`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_eventcomment_Add`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_eventcomment_Update`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_eventcomment_Delete`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_eventcomment_Search`;
...
CREATE TABLE `applicationtemplate`.`eventcomment` (
Id INT AUTO_INCREMENT,
Comment VARCHAR(32768),
CustomerId INT,
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_eventcomment_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_eventcomment_LoadAll`
()
BEGIN
	SELECT
		`eventcomment`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_eventcomment_Add`
(
	 IN paramComment VARCHAR(32768),
	 IN paramCustomerId INT,
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_eventcomment_Update`
(
	IN paramId INT,
	IN paramComment VARCHAR(32768),
	IN paramCustomerId INT,
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_eventcomment_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_eventcomment_Search`
(
	IN paramId INT,
	IN paramComment VARCHAR(32768),
	IN paramCustomerId INT,
...
DROP TABLE IF EXISTS `applicationtemplate`.`image`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_image_Load`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_image_LoadAll`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_image_Add`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_image_Update`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_image_Delete`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_image_Search`;
...
CREATE TABLE `applicationtemplate`.`image` (
Id INT AUTO_INCREMENT,
Name VARCHAR(255),
Description VARCHAR(1025),
ImgUrl VARCHAR(1025),
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_image_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_image_LoadAll`
()
BEGIN
	SELECT
		`image`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_image_Add`
(
	 IN paramName VARCHAR(255),
	 IN paramDescription VARCHAR(1025),
	 IN paramImgUrl VARCHAR(1025),
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_image_Update`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025),
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_image_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_image_Search`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025),
...
DROP TABLE IF EXISTS `applicationtemplate`.`imagecomment`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_imagecomment_Load`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_imagecomment_LoadAll`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_imagecomment_Add`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_imagecomment_Update`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_imagecomment_Delete`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_imagecomment_Search`;
...
CREATE TABLE `applicationtemplate`.`imagecomment` (
Id INT AUTO_INCREMENT,
Comment VARCHAR(32768),
CustomerId INT,
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_imagecomment_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_imagecomment_LoadAll`
()
BEGIN
	SELECT
		`imagecomment`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_imagecomment_Add`
(
	 IN paramComment VARCHAR(32768),
	 IN paramCustomerId INT,
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_imagecomment_Update`
(
	IN paramId INT,
	IN paramComment VARCHAR(32768),
	IN paramCustomerId INT,
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_imagecomment_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_imagecomment_Search`
(
	IN paramId INT,
	IN paramComment VARCHAR(32768),
	IN paramCustomerId INT,
...
DROP TABLE IF EXISTS `applicationtemplate`.`orderstatustype`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_orderstatustype_Load`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_orderstatustype_LoadAll`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_orderstatustype_Add`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_orderstatustype_Update`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_orderstatustype_Delete`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_orderstatustype_Search`;
...
CREATE TABLE `applicationtemplate`.`orderstatustype` (
Id INT AUTO_INCREMENT,
Name VARCHAR(255),
Description VARCHAR(1025),
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_orderstatustype_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_orderstatustype_LoadAll`
()
BEGIN
	SELECT
		`orderstatustype`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_orderstatustype_Add`
(
	 IN paramName VARCHAR(255),
	 IN paramDescription VARCHAR(1025)
)
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_orderstatustype_Update`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025)
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_orderstatustype_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_orderstatustype_Search`
(
	IN paramId INT,
	IN paramName VARCHAR(255),
	IN paramDescription VARCHAR(1025)
...
DROP TABLE IF EXISTS `applicationtemplate`.`order`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_order_Load`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_order_LoadAll`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_order_Add`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_order_Update`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_order_Delete`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_order_Search`;
...
CREATE TABLE `applicationtemplate`.`order` (
Id INT AUTO_INCREMENT,
CustomerId INT,
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_order_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_order_LoadAll`
()
BEGIN
	SELECT
		`order`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_order_Add`
(
	 IN paramCustomerId INT,
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_order_Update`
(
	IN paramId INT,
	IN paramCustomerId INT,
	IN paramOrderStatusTypeId INT,
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_order_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_order_Search`
(
	IN paramId INT,
	IN paramCustomerId INT,
	IN paramOrderStatusTypeId INT,
...
DROP TABLE IF EXISTS `applicationtemplate`.`orderitem`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_orderitem_Load`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_orderitem_LoadAll`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_orderitem_Add`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_orderitem_Update`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_orderitem_Delete`;
DROP PROCEDURE IF EXISTS `applicationtemplate`.`usp_orderitem_Search`;
...
CREATE TABLE `applicationtemplate`.`orderitem` (
Id INT AUTO_INCREMENT,
OrderId INT,
ItemId INT,
Quantity INT,
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_orderitem_Load`
(
	 IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_orderitem_LoadAll`
()
BEGIN
	SELECT
		`orderitem`.`Id` AS `Id`,
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_orderitem_Add`
(
	 IN paramOrderId INT,
	 IN paramItemId INT,
	 IN paramQuantity INT,
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_orderitem_Update`
(
	IN paramId INT,
	IN paramOrderId INT,
	IN paramItemId INT,
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_orderitem_Delete`
(
	IN paramId INT
)
BEGIN
...
DELIMITER //
CREATE PROCEDURE `applicationtemplate`.`usp_orderitem_Search`
(
	IN paramId INT,
	IN paramOrderId INT,
	IN paramItemId INT,
